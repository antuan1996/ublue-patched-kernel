...
[![build-ublue](https://github.com/antuan1996/ublue-patched-kernel/actions/workflows/build.yml/badge.svg)](https://github.com/antuan1996/ublue-patched-kernel/actions/workflows/build.yml)
...
> **Note**
> Everywhere in this repository, make sure to replace `antuan1996/ublue-patched-kernel` with the details of your own repository. Unless you used [`create-ublue-image`](https://github.com/EinoHR/create-ublue-image), in which case the previous repo identifier should already be your repo's details.
...
- First rebase to the unsigned image, to get the proper signing keys and policies installed:
  ```
  sudo rpm-ostree rebase ostree-unverified-registry:ghcr.io/antuan1996/ublue-patched-kernel:latest
  ```
...
- Then rebase to the signed image, like so:
  ```
  sudo rpm-ostree rebase ostree-image-signed:docker://ghcr.io/antuan1996/ublue-patched-kernel:latest
  ```
...
```
sudo rpm-ostree rebase ostree-image-signed:docker://ghcr.io/antuan1996/ublue-patched-kernel:20230403
```
